...
public class PdfCreator
{
    ...
    public void CreateReservationPdf(string fileName, Reservations reservation)
    {
        ...
        {
            str += a.Latitude.ToString(CultureInfo.InvariantCulture).Replace(",", ".") + "%2C" + a.Longitude.ToString(CultureInfo.InvariantCulture).Replace(",", ".") + "%7C";
        });

        if (str.Length >= 3) str = str[..^3];
        ...
        {
            commentStr = @$"<p style=""font-weight: bold; margin: 0px;"">COMMENT</p>
...
<div style=""display: flex; justify-content: space-between;width:100%;"">
            ...
            <div>
                      <p style=""margin: 0px;margin-left:.5rem;"">{reservation.DiscountRate}%</p>
            </div>
        </div>";
            }
...
<div style=""display: flex; justify-content: space-between;width:100%;"">
            <div>
                      <p style=""margin: 0px;"">{reservation.DiscountText}</p>
            </div>
        </div>
       ";
            }
...
<div style=""display: flex; justify-content: space-between;width:100%;text-decoration: line-through;"">
            ...
            <div>
                       <p style=""margin: 0px;margin-left:.5rem;"">{Math.Round(Convert.ToDecimal(reservation.OfferPrice + reservation.ServiceFee + reservation.SalesFee + reservation.ExtraServiceFee), 2)} €</p>
            </div>
        </div>
<div style=""display: flex; justify-content: space-between;width:100%;"">
            <div>
...
<div style=""display: flex; justify-content: space-between;width:100%;"">
            <div>
                       <p style=""margin: 0px;"">{reservation.Coupons.Comment} </p>
            </div>
        </div>
...
";
        ...
        <div style=""display: flex; justify-content: space-between;width:100%;"">
            ...
            <div>
                      <p style=""margin: 0px;margin-left:.5rem"">{(reservation.Coupon != 0 && reservation.Coupon != null ? reservation.DiscountOfferPrice : reservation.OfferPrice)} €</p>
            </div>
        </div>
        ...
        <div style=""display: flex; justify-content: space-between;width:100%;"">
            ...
            <div>
                      <p style=""margin: 0px;margin-left:.5rem;"">{(reservation.Coupon != 0 && reservation.Coupon != null ? reservation.DiscountServiceFee : reservation.ServiceFee)} €</p>
            </div>
        </div>

                <div style=""display: flex; justify-content: space-between;width:100%;"">
            <div>
                      <p style=""margin: 0px;"">Extra Service Price:</p>
            </div>
            <div>
                      <p style=""margin: 0px;margin-left:.5rem;"">{(reservation.Coupon != 0 && reservation.Coupon != null ? reservation.DiscountExtraService : reservation.ExtraServiceFee)} €</p>
            </div>
        </div>
...
<h3 style=""font-size: 23px;text-align: center;"">SERVICES DETAILS</h3>";
        ...
        {
            returnString =  $"""
                                             <p style="font-weight: bold; margin: 0;">RETURN DATE</p>
                                                 <div>
...
<body style=""margin: 0px; padding: 30px; font-family: 'Montserrat';"">
    <div style=""width: 100%;
        ...
        <p style=""font-size: 13px; font-weight: bold;"">BOOKING CONFIRMATION</p>
    </div>
    ...
    <div style=""padding: 5px 5px;"">
        ...
        <div>
            ...
            <p style=""margin:0px;""><span style=""font-weight: bold;"">Transport type: </span>
            ...
            <p style=""margin: 0px;""><span style=""font-weight: bold;"">Vehicle:</span> {reservation.LocationCars.Car.Brand.CarBrandName} {reservation.LocationCars.Car.Model.CarModelName} </p>
            <p style=""margin: 0px;""><span style=""font-weight: bold;"">License plate:</span> {reservation.LocationCars.Car.Plate}</p>
            <p style=""margin: 0px;"">
                <span style=""font-weight: bold;"">Options:</span>{(reservation.LocationCars.Car.Wifi ? "Free wifi" : "")}{(reservation.LocationCars.Car.Water ? ",Free water" : "")}{(reservation.LocationCars.Car.Partition ? ",Safety partition" : "")}{(reservation.LocationCars.Car.Charger ? ",Phone charger" : "")}
    ...
    <div style=""padding: 5px 5px;"">
        ...
        <div>
            <div style=""margin-left:20px;float: right;"">
                <img src=""data:image/png;base64,{base64String}"" width=""303px"" height=""156px"" alt=""Harita"">
            </div>
